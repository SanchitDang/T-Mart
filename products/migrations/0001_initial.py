    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ideal', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='products.Ideal_for')),
                ('neck', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='products.Neck_type')),
                ('occassion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='products.Occassion')),
                ('sleeve', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='products.Sleeve_type')),
            ],
        ),
        migrations.CreateModel(
            name='Sizevariant',
